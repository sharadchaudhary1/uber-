      ...
      <div className="flex flex-col justify-between h-screen bg-gray-50">
        <div className="p-7">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            {/* lastname */}
            <label className="block text-l font-medium text-gray-600 mt-3">
              Last Name
            </label>
            <input
              value={lastname}
        ...
        <div className="p-7 mb-10">
          <p className="text-[10px]">
            Uber provides a technology platform that connects riders (users
            seeking transportation) with drivers (independent service
            providers). Uber does not own vehicles or employ drivers directly.
            Each driver operates as an independent contractor
          </p>
        </div>
      </div>
      8
